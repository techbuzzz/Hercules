# Prompt: PostgreSQL Optimization & Review

## Purpose
Expert PostgreSQL guidance for the selected code or entire project. Focus on PostgreSQL-specific features, optimization patterns, and advanced capabilities.
