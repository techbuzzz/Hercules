...
builder.Services.AddSingleton<Hercules.Tools.ITool, Hercules.Tools.HttpTool>();
builder.Services.AddSingleton<Hercules.Tools.ITool, Hercules.Tools.A2AClient>();
builder.Services.AddSingleton<Hercules.Tools.ITool, Hercules.Tools.CodeExecutionTool>();
builder.Services.AddSingleton<Hercules.Tools.ToolRegistry>();
builder.Services.AddSingleton<Hercules.Tools.McpClient>();
...
builder.Services.AddSingleton<Hercules.Tools.ITool, WasmToolAdapter>();
...
builder.Services.AddSingleton<Hercules.Skills.SkillPackager>();

// Phase 2: Semantic routing (embedding-based). Stub provider — offline.
builder.Services.AddSingleton<Hercules.Skills.IEmbeddingProvider, Hercules.Skills.StubEmbeddingProvider>();
builder.Services.AddSingleton<Hercules.Skills.EmbeddingSkillRouter>();

// Phase 2: Skill marketplace + agent templates
builder.Services.AddSingleton<Hercules.Skills.SkillMarketplace>();
builder.Services.AddSingleton<Hercules.Skills.AgentTemplateManager>();
