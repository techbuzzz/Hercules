...
| # | Task | Slug | Status |
|---|------|------|--------|
| 1 | [Базовый цикл агента](tasks/task_001.md) | `core-agent-loop` | pending |
| 2 | [Жизненный цикл навыков](tasks/task_002.md) | `skill-lifecycle` | pending |
| 3 | [Гибридное хранилище](tasks/task_003.md) | `hybrid-storage` | pending |
| 4 | [Мульти-провайдер LLM](tasks/task_004.md) | `multi-provider-llm` | pending |
| 5 | [Интерфейсы](tasks/task_005.md) | `interfaces` | pending |
| 6 | [Тесты и бенчмарки](tasks/task_006.md) | `tests-and-benchmarks` | pending |
| 7 | [Типизированные контракты агента](tasks/task_007.md) | `typed-contracts` | pending |
| 8 | [Ограниченный цикл исполнения](tasks/task_008.md) | `bounded-execution` | pending |
...
| # | Task | Slug | Status |
|---|------|------|--------|
| 19 | [Формат пакета навыка](tasks/task_019.md) | `skill-package-format` | pending |
| 20 | [Манифест навыка и совместимость](tasks/task_020.md) | `skill-manifest` | pending |
| 21 | [Маркетплейс навыков](tasks/task_021.md) | `skill-marketplace` | pending |
| 22 | [Семантическая маршрутизация](tasks/task_022.md) | `semantic-routing` | pending |
| 23 | [Детерминированный fallback маршрутизатора](tasks/task_023.md) | `deterministic-router` | pending |
| 24 | [Реестр инструментов](tasks/task_024.md) | `tool-registry` | pending |
...
| 30 | [Шаблоны агентов](tasks/task_030.md) | `agent-templates` | pending |
...
| # | Task | Slug | Status |
|---|------|------|--------|
| 32 | [Манифест агента](tasks/task_032.md) | `agent-manifest` | pending |
| 33 | [A2A Agent Card совместимость](tasks/task_033.md) | `a2a-agent-card` | pending |
| 34 | [Capability registry](tasks/task_034.md) | `capability-registry` | pending |
| 35 | [Формат inter-agent сообщений](tasks/task_035.md) | `delegation-envelope` | pending |
| 36 | [Протокол жизненного цикла задач](tasks/task_036.md) | `task-lifecycle-protocol` | pending |
| 37 | [Опции транспорта](tasks/task_037.md) | `transports` | pending |
| 38 | [Механизмы discovery](tasks/task_038.md) | `discovery` | pending |
...
| # | Task | Slug | Status |
|---|------|------|--------|
| 43 | [Mesh router](tasks/task_043.md) | `mesh-router` | pending |
| 44 | [Сложность и стоимость](tasks/task_044.md) | `complexity-router` | pending |
| 45 | [Fan-out / fan-in](tasks/task_045.md) | `fan-out-in` | pending |
| 46 | [Verification pipeline](tasks/task_046.md) | `verification-pipeline` | pending |
| 47 | [Retry, timeout, circuit breaker](tasks/task_047.md) | `retry-timeout-breaker` | pending |
| 48 | [Границы делегации](tasks/task_048.md) | `delegation-boundaries` | pending |
| 49 | [Human-in-the-loop эскалация](tasks/task_049.md) | `human-escalation` | pending |
...
| # | Task | Slug | Status |
|---|------|------|--------|
| 53 | [Mesh dashboard](tasks/task_053.md) | `mesh-dashboard` | pending |
| 54 | [Централизованные логи и трейсы](tasks/task_054.md) | `centralized-observability` | pending |
| 55 | [Security operations](tasks/task_055.md) | `security-ops` | pending |
| 56 | [Rate limits и квоты](tasks/task_056.md) | `rate-limits-quotas` | pending |
| 57 | [Управление жизненным циклом](tasks/task_057.md) | `lifecycle-management` | pending |
| 58 | [Configuration и policy rollout](tasks/task_058.md) | `config-policy-rollout` | pending |
| 59 | [Edge provisioning](tasks/task_059.md) | `edge-provisioning` | pending |
| 60 | [Offline resilience](tasks/task_060.md) | `offline-resilience` | pending |
| 61 | [Local-first degradation](tasks/task_061.md) | `local-degradation` | pending |
| 62 | [Fleet templates](tasks/task_062.md) | `fleet-templates` | pending |
| 63 | [Backup и recovery](tasks/task_063.md) | `backup-recovery` | pending |
| 64 | [Операционные SLO](tasks/task_064.md) | `operational-slos` | pending |
